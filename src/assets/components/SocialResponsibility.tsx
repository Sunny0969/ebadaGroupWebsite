...
const DEI_INITIATIVES = [
  {
    ...
    description:
      "Ebadah Group holds both the Platinum Kurumin (子育てサポート企業) certification and the Eruboshi three-star rating under Japan's Women's Advancement Promotion Act. We provide education programmes, awareness activities, and a workplace culture that enables women to advance into leadership roles while balancing work and family life.",
    icon: "👩‍💼",
  },
  {
    title: "International Worker Integration",
    description:
      "Diversity management at Ebadah Group means maximising the contribution of all talent — including foreign national workers, who bring unique skills, international perspectives, and new ideas to our clients. We provide language support, cultural orientation, and dedicated multilingual coordinators to ensure full integration.",
    icon: "🌍",
  },
  {
    title: "Support for Workers with Disabilities",
    description:
      "Ebadah Group operates the Dinkle Job Support Centre, a registered disability employment support office designated by Utsunomiya City. We are committed to creating meaningful employment pathways for individuals with disabilities, providing tailored placement support and ongoing workplace accommodation.",
    icon: "🤝",
  },
  {
    title: "Work-Life Balance & Flexible Working",
    description:
      "Recognising that individuals do not all start from the same position, Ebadah Group applies an equity-based approach — providing different tools and resources according to each person's circumstances. Flexible working arrangements, childcare and nursing care support, and work-life balance initiatives are core to our inclusive culture.",
    icon: "⚖️",
  },
];
...
const COMMUNITY_PROGRAMS = [
  {
    ...
    description:
      "Ebadah Group actively participates in regional revitalisation initiatives — addressing Japan's population concentration in Tokyo and supporting local industrial communities. We are registered members of the Tochigi SDGs Promotion Enterprise programme and the Utsunomiya SDGs Human Resource Development Platform.",
    icon: "🏘️",
  },
  {
    title: "Sports & Culture Sponsorship",
    description:
      "Ebadah Group is an Official Sponsor of Utsunomiya Brex (B.League basketball), supporting local sports culture and community engagement. We actively promote health, teamwork, and community spirit through sports sponsorships across the regions where we operate.",
    icon: "⚽",
  },
  {
    title: "Single-Parent Employment Support",
    description:
      "In partnership with Utsunomiya City, Ebadah Group operates a single-parent employment support programme — providing dedicated job matching, career counselling, and flexible employment arrangements for single-parent households re-entering the workforce.",
    icon: "🌱",
  },
  {
    title: "Next-Generation Development & Education",
    description:
      "Ebadah Group supports the next generation of workers through vocational education partnerships, pre-employment training programmes, and ongoing qualification support. We believe investing in young talent today is essential to sustaining Japan's industrial workforce tomorrow.",
    icon: "🎓",
  },
];
      ...
      <section className="sus-hero">
        <div className="sus-wrap">
          ...
          <p className="sus-hero__p">
            ...
            investing in the communities where we operate — these are not aspirations at Ebadah Group.
        ...
        <div className="sus-wrap">
          ...
          >
            <p style={{ color: "var(--txt-2)", fontSize: "1.05rem", lineHeight: 1.9, marginBottom: "1.5rem" }}>
              Ebadah Group is founded on the principle of creating employment opportunities and the
            ...
            <p style={{ color: "var(--txt-2)", fontSize: "1.05rem", lineHeight: 1.9, marginBottom: "1.5rem" }}>
              Ebadah Group respects and upholds the human rights of all employees and all persons
            ...
            <p style={{ color: "var(--txt-2)", fontSize: "1.05rem", lineHeight: 1.9, marginBottom: "1.5rem" }}>
              ...
              employees of Ebadah Group, and we ask all business partners and associated parties
            ...
            >
              {[
                { label: "Scope",              body: "All executives, employees, business partners, and related parties across all Ebadah Group operations." },
        ...
        <div className="sus-wrap">
          <div className="sus-sh">
            ...
            <p className="sus-sh__p">
              Ebadah Group pursues diversity management as a core business strategy — maximising
        ...
        <div className="sus-wrap">
          <div className="sus-sh">
            ...
            <p className="sus-sh__p">
              ...
              parties is Ebadah Group's highest priority in all business activities. Our goal is
          ...
          >
            ...
            >
              Ebadah Group Safety & Health Policy — Five Pillars
            </h3>
      ...
      >
        <div className="sus-wrap">
          <div className="sus-sh">
            ...
            <p className="sus-sh__p">
              Ebadah Group believes that as a staffing company, we have a direct responsibility to
